...
WHERE P.userid =PR.userid and PR.all_movies in (SELECT T.movieId FROM tags T, links lk, (SELECT DISTINCT T.tag FROM tags T, links lk WHERE T.movieId = lk.movieId AND lk.tmdbId = ?) tags WHERE T.movieId = lk.movieId AND lk.tmdbId != ? AND T.tag = tags.tag)
